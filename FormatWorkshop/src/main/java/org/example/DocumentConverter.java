...
public class DocumentConverter extends Converter{
    private String[] formats = {"csv", "jpg", "doc", "docx", "dot", "log", "odt", "ppt", "pptx", "rtf", "txt", "wpd", "wps", "wri", "xls", "xlsx", "xml"};
    ...
    public String getSource(JFileChooser fc){
        ...
        System.out.println("*** Please select the Documents you want to convert from: **");
    ...
    public String getDestination(JFileChooser fc){
        ...
        System.out.println("*** Please specify where to save the new document ***");
    ...
    public void getOptions() {
        System.out.println("*** YOU CAN CONVERT DOCUMENTS FRON AND TO THE FOLLOWING TYPES: ***");
    ...
    @Override
    public void convert() {
       // Config.setDefaultSecret("QhBbuB9svP8oYCo6");
